...
beautiful.init("/home/bostick/.config/awesome/gruvbox/theme.lua")
...
-- Original menu - keeping for debugging purposes
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, size = 26 })
...
--                     placement = awful.placement.centered+awful.placement.no_overlap+awful.placement.no_offscreen
    ...
    -- Disable window focusing on xfce4-panel
